# Compare the number of iterations it takes for a player to guess the seceret as the number of particularly sensitive shares changes.
import random
import numpy as np
...
print(len(tracker))
plt.scatter([i for i in range(len(tracker))], tracker, color='purple')
plt.xlabel('Number of Particularly Sensitive Shares')
plt.ylabel('Number of Iterations')
plt.title('Number of Particularly Sensitive Shares \n vs Number of Iterations to Learn the Secret')
plt.show()
