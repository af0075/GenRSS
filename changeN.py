...
plt.scatter([i*20 for i in range(len(tracker))], tracker, color='purple')
plt.xlabel('Population Size')
plt.ylabel('Number of Iterations')
plt.title('Population Size vs Number of Iterations to Learn the Secret')
plt.show()
