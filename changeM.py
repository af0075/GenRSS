# Compare the number of iterations it takes for a player to guess the seceret as the number of distinct shares changes.
import random
import numpy as np
...
for p in range(1,27):
    ...
    t, m = 100, 100+2*p # Threshold values
...
plt.scatter([100+2*i for i in range(len(tracker))], tracker, color='purple')
plt.xlabel('Number of Distinct Shares')
plt.ylabel('Number of Iterations')
plt.title('Number of Distinct Shares \n vs Number of Iterations to Learn the Secret')
plt.show()
